...
<li>Student ID:</li><li><input type="text" name="Customer ID" /></li>
<li>Full Name:</li><li><input type="text" name="Customer Name" /></li>
<li>Email:</li><li><input type="text" name="Customer Phone" /></li>
