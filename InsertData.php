...
<li>Customer ID:</li><li><input type="text" name="Customer ID" /></li>
<li>Customer Name:</li><li><input type="text" name="Customer Name" /></li>
<li>Customer Phone:</li><li><input type="text" name="Customer Phone" /></li>
